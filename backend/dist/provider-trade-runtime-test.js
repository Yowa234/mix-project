...
import { createProviderExecutionContext, executeProviderHealth, executeProviderTradeQuery, resetProviderTradeRuntimeStateForTests } from "./provider-runtime.js";
...
const defaultCatalog = foundCatalog;
const query = {
    reporterCodes: ["842"],
    partnerCodes: ["0"],
    flow: "import",
...
function context(teamId, ownerId, runId) {
...
function connection(teamId, ownerId, id) {
...
let markSharedRequestStarted;
const sharedRequestStarted = new Promise((resolve) => {
    markSharedRequestStarted = resolve;
});
const sharedRequestGate = new Promise((resolve) => {
...
const concurrentRequestGate = new Promise((resolve) => {
...
clearRuntime();
externalRequests = 0;
let releaseSharedFailure;
let markSharedFailureStarted;
const sharedFailureStarted = new Promise((resolve) => {
    markSharedFailureStarted = resolve;
});
const sharedFailureGate = new Promise((resolve) => {
...
const leaderFailureLogs = [];
const followerFailureLogs = [];
