...
$title = function_exists('get_field') ? (get_field('title') ?: "未命名网站 Industrial Systems Solutions for Global Buyers") : "未命名网站 Industrial Systems Solutions for Global Buyers";
$intro = function_exists('get_field') ? (get_field('intro') ?: "Open with a credible industrial B2B value proposition for 未命名网站. Show product strength, export readiness, delivery capability, and a clear inquiry CTA. Visual style: industrial-professional.") : "Open with a credible industrial B2B value proposition for 未命名网站. Show product strength, export readiness, delivery capability, and a clear inquiry CTA. Visual style: industrial-professional.";
