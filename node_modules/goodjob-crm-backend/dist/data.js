...
export const providerCatalog = createDefaultProviderCatalog();
export const providerConnections = [];
export const providerRequestLogs = [];
export const providerResponseCache = [];
export const marketTradeObservations = [];
export const marketOpportunityBatches = [];
export const marketOpportunitySnapshots = [];
export const marketOpportunityCalculationEvents = [];
export const agentJobs = [];
export const agentJobIdempotencyAliases = [];
export const prospectCampaigns = [];
export const prospectCampaignVersions = [];
export const prospectCampaignEvents = [];
export const prospectStrategies = [];
export const prospectStrategyEvents = [];
export const prospectSchedules = [];
export const prospectSearchRuns = [];
export const prospectRunShards = [];
export const prospectRunEvents = [];
export const prospectRunQueueParentBindings = [];
export const prospectRunQueueChildBindings = [];
export const prospectExecutionKernelStates = [];
export const prospectExecutionCheckpoints = [];
export const prospectStrategySourcePositions = [];
export const prospectExecutionLeases = [];
export const prospectExecutionAttempts = [];
export const prospectProviderRequestLedgers = [];
export const prospectProviderRequestDispatches = [];
export const prospectProviderRequestEvents = [];
export const prospectProviderRequestAttemptBindings = [];
export const prospectProviderRequestAccountingEvidence = [];
export const prospectSourceRawBatches = [];
export const prospectSourceRawRecords = [];
export const prospectSourceRawHits = [];
export const organizations = [];
export const organizationIdentityClaims = [];
export const organizationAcceptedIdentifiers = [];
export const organizationIdentityResolutions = [];
export const organizationSourceBindings = [];
export const organizationIdentityConflicts = [];
export const organizationIdentityConflictReviews = [];
export const organizationCanonicalMappings = [];
export const organizationAliasFacts = [];
export const organizationRelationFacts = [];
export const organizationIdentityEvents = [];
export const tenantProspects = [];
export const prospectCoverageEvents = [];
export const prospectEvidence = [];
export const companyVerificationSnapshots = [];
export const prospectIcpPolicySnapshots = [];
export const prospectIcpAssessmentSnapshots = [];
export const prospectContacts = [];
export const prospectContactChannels = [];
export const prospectContactVerificationSnapshots = [];
export const prospectSuppressionEvents = [];
export const prospectContactabilityDecisions = [];
export const prospectTouchpoints = [];
export const procurementSignals = [];
export const dealRecommendations = [];
export const customerIntelligenceSuggestions = [];
export const acquisitionOutcomeFeedback = [];
export const prospectStrategySuggestions = [];
export const prospectExecutionPages = [];
export const prospectExecutionEvents = [];
export const prospectExecutionThrottleBuckets = [];
export const dailyReports = [];
export const dailyReportComments = [];
...
export const examQuestionLinks = [
...
export const websiteOpportunities = [
    {
        id: "web_seed_1",
...
export const aiSiteBuilderProjects = [];
export const aiSiteBuilderSettings = [];
...
export const monthlySalesRecords = [];
export const salesRecordAudits = [];
export const commissionCalculations = [];
export const commissionItems = [];
export const commissionExports = [];
export const deals = [
