...
import { ORGANIZATION_STRONG_IDENTITY_CONTRACT, OrganizationStrongIdentityError, normalizeOrganizationIdentityAuthorityProfile, organizationIdentityAuthorityProfileHash, organizationIdentityConflictRelationHash, organizationIdentityConflictRelations, organizationIdentityResolutionRelationHash, organizationIdentityResolutionRelations, resolveOrganizationStrongIdentity, validateOrganizationIdentityFacts } from "./organization-strong-identity.js";
...
const IDENTITY_STATE_TABLES = IDENTITY_TABLES.filter((table) => table !== "organization_identity_contract_metadata");
const NAMED_DUPLICATE_RECOVERY_RULES = [
    {
...
const duplicateWriteTables = new WeakMap();
const identityCacheVersions = new WeakMap();
...
function frozenPersistedInput(input) {
...
function frozenAuthorityProfile(profile) {
...
function schemaIndex(name, unique, ...columns) {
    return { name, unique, columns };
}
function schemaForeignKey(name, columns, referencedTable, referencedColumns) {
    return { name, columns, referencedTable, referencedColumns };
}
function schemaCheck(name, clause) {
    return { name, clause };
}
const RAW_RECORD_SCHEMA = {
    columns: [
        ["id", "varchar(90)"],
        ["team_id", "varchar(64)"],
        ["owner_id", "varchar(64)"],
    ...
    indexes: [
        ...
        schemaIndex("uk_ps_raw_record_team_owner_id", true, "team_id", "owner_id", "id"),
        schemaIndex("uk_ps_raw_record_version", true, "team_id", "owner_id", "provider_code", "connection_id", "endpoint_code", "source_identity_hash", "artifact_hash")
    ],
    checks: [
        schemaCheck("chk_ps_raw_record_envelope_version", "(envelope_version = 'provider-raw-v1')")
    ]
};
const IDENTITY_SCHEMA = {
    ...
    organizations: {
        ...
        checks: [
            schemaCheck("chk_oi_organization_scope", "((scope_type = 'team') AND (scope_id = team_id))"),
    ...
    organization_identity_resolutions: {
        ...
        indexes: [
            schemaIndex("PRIMARY", true, "id"),
            schemaIndex("fk_oi_resolution_raw", false, "team_id", "owner_id", "raw_record_id"),
            schemaIndex("uk_oi_resolution_processing", true, "team_id", "owner_id", "processing_key_hash"),
            schemaIndex("uk_oi_resolution_team_owner_id", true, "team_id", "owner_id", "id")
        ],
        foreignKeys: [
            schemaForeignKey("fk_oi_resolution_raw", ["team_id", "owner_id", "raw_record_id"], "prospect_source_raw_records", ["team_id", "owner_id", "id"])
        ],
        checks: [
            schemaCheck("chk_oi_resolution_result", "(result IN ('new_entity','exact_match',"
    ...
    organization_identity_claims: {
        ...
        indexes: [
            schemaIndex("PRIMARY", true, "id"),
            schemaIndex("fk_oi_claim_raw", false, "team_id", "owner_id", "raw_record_id"),
            schemaIndex("uk_oi_claim_resolution_ordinal", true, "team_id", "owner_id", "resolution_id", "ordinal"),
            schemaIndex("uk_oi_claim_team_owner_id", true, "team_id", "owner_id", "id")
        ],
        foreignKeys: [
            schemaForeignKey("fk_oi_claim_resolution", ["team_id", "owner_id", "resolution_id"], "organization_identity_resolutions", ["team_id", "owner_id", "id"]),
            schemaForeignKey("fk_oi_claim_raw", ["team_id", "owner_id", "raw_record_id"], "prospect_source_raw_records", ["team_id", "owner_id", "id"])
        ],
    ...
    organization_accepted_identifiers: {
        ...
        indexes: [
            schemaIndex("PRIMARY", true, "id"),
            schemaIndex("fk_oi_identifier_claim", false, "team_id", "source_owner_id", "source_claim_id"),
            schemaIndex("fk_oi_identifier_organization", false, "team_id", "organization_id"),
            schemaIndex("fk_oi_identifier_raw", false, "team_id", "source_owner_id", "source_raw_record_id"),
            schemaIndex("uk_oi_identifier_lookup", true, "team_id", "kind", "scheme", "jurisdiction", "normalized_value_hash"),
            schemaIndex("uk_oi_identifier_team_id", true, "team_id", "id")
        ],
        foreignKeys: [
            schemaForeignKey("fk_oi_identifier_organization", ["team_id", "organization_id"], "organizations", ["team_id", "id"]),
            schemaForeignKey("fk_oi_identifier_claim", ["team_id", "source_owner_id", "source_claim_id"], "organization_identity_claims", ["team_id", "owner_id", "id"]),
            schemaForeignKey("fk_oi_identifier_raw", ["team_id", "source_owner_id", "source_raw_record_id"], "prospect_source_raw_records", ["team_id", "owner_id", "id"])
        ],
        checks: [
    ...
    organization_source_bindings: {
        ...
        indexes: [
            schemaIndex("PRIMARY", true, "id"),
            schemaIndex("fk_oi_binding_organization", false, "team_id", "organization_id"),
            schemaIndex("fk_oi_binding_resolution", false, "team_id", "owner_id", "resolution_id"),
            schemaIndex("uk_oi_binding_active_raw", true, "team_id", "owner_id", "raw_record_id", "status"),
            schemaIndex("uk_oi_binding_team_owner_id", true, "team_id", "owner_id", "id")
        ],
        foreignKeys: [
            schemaForeignKey("fk_oi_binding_organization", ["team_id", "organization_id"], "organizations", ["team_id", "id"]),
            schemaForeignKey("fk_oi_binding_resolution", ["team_id", "owner_id", "resolution_id"], "organization_identity_resolutions", ["team_id", "owner_id", "id"]),
            schemaForeignKey("fk_oi_binding_raw", ["team_id", "owner_id", "raw_record_id"], "prospect_source_raw_records", ["team_id", "owner_id", "id"])
        ],
    ...
    organization_identity_conflicts: {
        ...
        indexes: [
            schemaIndex("PRIMARY", true, "id"),
            schemaIndex("fk_oi_conflict_raw", false, "team_id", "owner_id", "raw_record_id"),
            schemaIndex("uk_oi_conflict_resolution", true, "team_id", "owner_id", "resolution_id"),
            schemaIndex("uk_oi_conflict_team_owner_id", true, "team_id", "owner_id", "id")
        ],
        foreignKeys: [
            schemaForeignKey("fk_oi_conflict_resolution", ["team_id", "owner_id", "resolution_id"], "organization_identity_resolutions", ["team_id", "owner_id", "id"]),
            schemaForeignKey("fk_oi_conflict_raw", ["team_id", "owner_id", "raw_record_id"], "prospect_source_raw_records", ["team_id", "owner_id", "id"])
        ],
    ...
    organization_identity_events: {
        ...
        indexes: [
            schemaIndex("PRIMARY", true, "id"),
            schemaIndex("uk_oi_event_resolution_sequence", true, "team_id", "owner_id", "resolution_id", "sequence_no"),
            schemaIndex("uk_oi_event_team_owner_id", true, "team_id", "owner_id", "id")
        ],
        foreignKeys: [
            schemaForeignKey("fk_oi_event_resolution", ["team_id", "owner_id", "resolution_id"], "organization_identity_resolutions", ["team_id", "owner_id", "id"])
        ],
    ...
    organization_identity_resolution_identifiers: {
        ...
        indexes: [
            schemaIndex("PRIMARY", true, "team_id", "owner_id", "resolution_id", "ordinal"),
            schemaIndex("fk_oi_resolution_identifier_identifier", false, "team_id", "identifier_id"),
            schemaIndex("uk_oi_resolution_identifier_role", true, "team_id", "owner_id", "resolution_id", "identifier_id", "relation_role")
        ],
        foreignKeys: [
            schemaForeignKey("fk_oi_resolution_identifier_resolution", ["team_id", "owner_id", "resolution_id"], "organization_identity_resolutions", ["team_id", "owner_id", "id"]),
            schemaForeignKey("fk_oi_resolution_identifier_identifier", ["team_id", "identifier_id"], "organization_accepted_identifiers", ["team_id", "id"])
        ],
        checks: [
            schemaCheck("chk_oi_resolution_identifier_ordinal", "(ordinal >= 1)"),
            schemaCheck("chk_oi_resolution_identifier_role", "(relation_role IN "
                + "('matched_existing','accepted_existing','accepted_new'))")
        ]
    },
    organization_identity_resolution_bindings: {
        ...
        indexes: [
            schemaIndex("PRIMARY", true, "team_id", "owner_id", "resolution_id", "ordinal"),
            schemaIndex("fk_oi_resolution_binding_binding", false, "team_id", "owner_id", "binding_id"),
            schemaIndex("uk_oi_resolution_binding_role", true, "team_id", "owner_id", "resolution_id", "binding_id", "relation_role")
        ],
        foreignKeys: [
            schemaForeignKey("fk_oi_resolution_binding_resolution", ["team_id", "owner_id", "resolution_id"], "organization_identity_resolutions", ["team_id", "owner_id", "id"]),
            schemaForeignKey("fk_oi_resolution_binding_binding", ["team_id", "owner_id", "binding_id"], "organization_source_bindings", ["team_id", "owner_id", "id"])
        ],
        checks: [
            schemaCheck("chk_oi_resolution_binding_ordinal", "(ordinal >= 1)"),
            schemaCheck("chk_oi_resolution_binding_role", "(relation_role IN ('reused_existing','created_new'))")
        ]
    },
    organization_identity_conflict_organizations: {
        columns: [
        ...
        indexes: [
            schemaIndex("PRIMARY", true, "team_id", "owner_id", "conflict_id", "ordinal"),
            schemaIndex("fk_oi_conflict_organization_organization", false, "team_id", "organization_id")
        ],
        foreignKeys: [
            schemaForeignKey("fk_oi_conflict_organization_conflict", ["team_id", "owner_id", "conflict_id"], "organization_identity_conflicts", ["team_id", "owner_id", "id"]),
            schemaForeignKey("fk_oi_conflict_organization_organization", ["team_id", "organization_id"], "organizations", ["team_id", "id"])
        ],
        checks: [
            schemaCheck("chk_oi_conflict_organization_ordinal", "(ordinal >= 1)"),
            schemaCheck("chk_oi_conflict_organization_role", "(relation_role IN ('identifier_match','existing_binding'))")
        ]
    },
    organization_identity_conflict_keys: {
        columns: [
        ...
        foreignKeys: [
            schemaForeignKey("fk_oi_conflict_key_conflict", ["team_id", "owner_id", "conflict_id"], "organization_identity_conflicts", ["team_id", "owner_id", "id"])
        ],
        checks: [
            schemaCheck("chk_oi_conflict_key_ordinal", "(ordinal >= 1)"),
            schemaCheck("chk_oi_conflict_key_type", "(key_type IN "
...
function canonical(value) {
    ...
    if (typeof result !== "string") {
        throw new OrganizationStrongIdentityError("IDENTITY_DATA_INTEGRITY_VIOLATION", "企业身份持久化对象无法 Canonical 化");
    }
    return result;
}
...
function configurationError(message) {
    throw new OrganizationStrongIdentityError("IDENTITY_CONFIGURATION_INVALID", message);
}
function integrityError(message) {
    throw new OrganizationStrongIdentityError("IDENTITY_DATA_INTEGRITY_VIOLATION", message);
}
...
function deriveKey(master, info) {
    return Buffer.from(hkdfSync("sha256", Buffer.from(master, "utf8"), HKDF_SALT, Buffer.from(info, "utf8"), 32));
}
function configuredSecrets(required) {
    const master = process.env.ORGANIZATION_IDENTITY_MASTER_SECRET;
    const raw = process.env.PROSPECT_SOURCE_RAW_ENVELOPE_SECRET;
    if (!master && !raw && !required)
        return null;
    const checkedMaster = requireSecret("ORGANIZATION_IDENTITY_MASTER_SECRET", master);
    const checkedRaw = requireSecret("PROSPECT_SOURCE_RAW_ENVELOPE_SECRET", raw);
    const processing = deriveKey(checkedMaster, "processing-key-hmac-v1");
    const deterministic = deriveKey(checkedMaster, "deterministic-id-hmac-v1");
    const lookup = deriveKey(checkedMaster, "identifier-lookup-hmac-v1");
    const encryption = deriveKey(checkedMaster, "field-encryption-aes256gcm-v1");
    const integrity = deriveKey(checkedMaster, "fact-integrity-hmac-v1");
    return {
...
function keyFingerprint(keyPurpose, key) {
...
function metadataBase(secrets, createdAt) {
    return {
        id: 1,
        ...
        key_fingerprints_json: canonical({
            processing: keyFingerprint("processing-key-hmac-v1", secrets.processingSecret),
            deterministic: keyFingerprint("deterministic-id-hmac-v1", secrets.deterministicIdSecret),
            lookup: keyFingerprint("identifier-lookup-hmac-v1", secrets.identifierLookupSecret),
            encryption: keyFingerprint("field-encryption-aes256gcm-v1", secrets.fieldEncryptionKey),
            integrity: keyFingerprint("fact-integrity-hmac-v1", secrets.factIntegrityKey)
        }),
        raw_key_fingerprint: keyFingerprint("prospect-source-raw-envelope-v1", secrets.rawEnvelopeSecret),
        status: "active",
        created_at: createdAt
    };
}
function metadataMac(row, secrets) {
...
function encryptField(value, key, aad) {
...
function decryptField(envelope, key, aad) {
    try {
...
function iso(value) {
    ...
    if (!Number.isFinite(date.getTime()))
        integrityError("数据库时间字段无效");
    return date.toISOString();
}
async function queryRows(source, sql, values = []) {
    const [rows] = await source.query(sql, values);
    return rows;
}
function mysqlErrorNumber(error) {
...
function namedDuplicateRecoveryRule(error) {
    ...
    const match = details.sqlMessage.match(/^Duplicate entry '.+' for key '([A-Za-z0-9_]+(?:\.[A-Za-z0-9_]+){0,2})'$/u);
    if (!match)
        return null;
    const parts = match[1].split(".");
    if (parts.some((part) => !part || part.length > 64))
        return null;
    ...
    return NAMED_DUPLICATE_RECOVERY_RULES.find((rule) => rule.table === writeTable && rule.constraint === constraint) || null;
}
...
function trustedProfile(code, version) {
    const profile = trustedProfiles().find((item) => item.profileCode === code && item.profileVersion === version);
    if (!profile) {
...
async function validateSchemaTables(connection, entries, optionalIndexes = new Set()) {
    if (!entries.length)
        return;
    const tableNames = entries.map(([tableName]) => tableName);
    const placeholders = tableNames.map(() => "?").join(",");
    const tables = await queryRows(connection, `SELECT table_name AS tableName, engine AS engineName
     FROM information_schema.tables
     WHERE table_schema = DATABASE()
       AND table_name IN (${placeholders})`, tableNames);
    const actualTables = new Map(tables.map((row) => [row.tableName, row.engineName]));
    ...
    const columns = await queryRows(connection, `SELECT table_name AS tableName, column_name AS columnName,
     ...
     ORDER BY table_name, ordinal_position`, tableNames);
    for (const [tableName, manifest] of entries) {
        ...
        manifest.columns.forEach(([columnName, columnType], index) => {
            ...
            if (!row
                ...
                || row.columnExtra !== "") {
                integrityError(`Schema ${tableName}.${columnName} 列定义不匹配`);
            }
        });
    }
    const indexRows = await queryRows(connection, `SELECT table_name AS tableName, index_name AS indexName,
    ...
    for (const [tableName, manifest] of entries) {
        const actualNames = new Set(indexRows
            .filter((row) => row.tableName === tableName)
            .map((row) => row.indexName));
        const expectedNames = new Set(manifest.indexes.map((index) => index.name));
        ...
        for (const expected of manifest.indexes) {
            ...
            const actual = indexRows.filter((row) => row.tableName === tableName && row.indexName === expected.name);
            if (!actual.length && optionalIndexes.has(key))
                continue;
            if (actual.length !== expected.columns.length
                || actual.some((row, index) => Number(row.nonUnique) !== (expected.unique ? 0 : 1)
    ...
    const foreignKeyRows = await queryRows(connection, `SELECT k.table_name AS tableName,
     ...
     ORDER BY k.table_name, k.constraint_name, k.ordinal_position`, tableNames);
    for (const [tableName, manifest] of entries) {
        const expectedForeignKeys = manifest.foreignKeys || [];
        const actualNames = new Set(foreignKeyRows
            .filter((row) => row.tableName === tableName)
        ...
        for (const expected of expectedForeignKeys) {
            const actual = foreignKeyRows.filter((row) => row.tableName === tableName
                && row.constraintName === expected.name);
            if (actual.length !== expected.columns.length
                || actual.some((row, index) => Number(row.ordinalPosition) !== index + 1
                    || row.columnName !== expected.columns[index]
    ...
    const checkRows = await queryRows(connection, `SELECT tc.table_name AS tableName,
     ...
     ORDER BY tc.table_name, tc.constraint_name`, tableNames);
    for (const [tableName, manifest] of entries) {
        ...
        for (const expected of expectedChecks) {
            const row = actual.find((item) => item.constraintName === expected.name);
            if (!row
                || row.enforced !== "YES"
...
async function validateRawRecordSchema(connection, allowMissingOwnerIndex) {
    const optional = allowMissingOwnerIndex
        ? new Set([
            "prospect_source_raw_records:uk_ps_raw_record_team_owner_id"
        ])
        : new Set();
    await validateSchemaTables(connection, [["prospect_source_raw_records", RAW_RECORD_SCHEMA]], optional);
}
async function ensureRawOwnerIndex(connection) {
    const duplicates = await queryRows(connection, `SELECT COUNT(*) AS count FROM (
    ...
    const indexRows = await queryRows(connection, `SELECT COUNT(DISTINCT index_name) AS count
     FROM information_schema.statistics
     WHERE table_schema = DATABASE()
       AND table_name = 'prospect_source_raw_records'
       AND index_name = 'uk_ps_raw_record_team_owner_id'`);
    if (Number(indexRows[0]?.count || 0) === 0) {
        await connection.query(`ALTER TABLE prospect_source_raw_records
       ADD UNIQUE KEY uk_ps_raw_record_team_owner_id(team_id, owner_id, id)`);
    }
}
function identitySchemaEntries(tableNames) {
    return tableNames.map((tableName) => [
        tableName,
        IDENTITY_SCHEMA[tableName]
    ]);
}
async function validateIdentitySchema(connection, tableNames = IDENTITY_TABLES) {
    await validateSchemaTables(connection, identitySchemaEntries(tableNames));
}
export async function ensureOrganizationIdentitySchema(pool) {
    const connection = await pool.getConnection();
    let acquired = false;
    let acquisitionOutcomeKnown = false;
    let destroyed = false;
    try {
        const lock = await queryRows(connection, "SELECT GET_LOCK(?, 30) AS acquired", [SCHEMA_LOCK]);
        ...
        const existing = await queryRows(connection, `SELECT table_name AS tableName
       FROM information_schema.tables
       WHERE table_schema = DATABASE()
         AND table_name IN (${IDENTITY_TABLES.map(() => "?").join(",")})`, [...IDENTITY_TABLES]);
        const existingNames = existing.map((row) => row.tableName);
        if (existing.length > 0 && existing.length < IDENTITY_TABLES.length) {
            for (const row of existing) {
                const count = await queryRows(connection, `SELECT COUNT(*) AS count FROM \`${row.tableName}\``);
        ...
        if (!acquisitionOutcomeKnown) {
            ...
            try {
                const released = await queryRows(connection, "SELECT RELEASE_LOCK(?) AS released", [SCHEMA_LOCK]);
            ...
            if (releaseFailed) {
                connection.destroy();
                destroyed = true;
                throw new OrganizationStrongIdentityError("IDENTITY_DATA_INTEGRITY_VIOLATION", "Organization Identity Schema 锁释放结果无法确认");
            }
        }
        if (!destroyed)
            connection.release();
...
async function factRowCount(source) {
    let total = 0;
    for (const table of IDENTITY_STATE_TABLES) {
        const rows = await queryRows(source, `SELECT COUNT(*) AS count FROM \`${table}\``);
        total += Number(rows[0]?.count || 0);
    }
    return total;
}
async function validateMetadata(source, secrets, lockForUpdate = false) {
    const rows = await queryRows(source, `SELECT * FROM organization_identity_contract_metadata
    ...
    if (rows.length !== 1)
        integrityError("身份 Contract Metadata 不唯一");
    if (!secrets) {
...
async function initializeMetadata(connection, secrets, createdAt) {
    if (await validateMetadata(connection, secrets, true))
        return;
    const row = metadataBase(secrets, createdAt);
    await connection.query(`INSERT INTO organization_identity_contract_metadata (
...
function profileStorage(profile, createdAt, secrets) {
    ...
    return {
        ...withProfileMac,
        row_mac: rowMac("organization_identity_authority_profiles", withProfileMac, secrets.factIntegrityKey)
    };
}
async function registerProfile(connection, profile, createdAt, secrets) {
    const expected = profileStorage(profile, createdAt, secrets);
    await connection.query(`INSERT INTO organization_identity_authority_profiles (
    ...
    const rows = await queryRows(connection, `SELECT * FROM organization_identity_authority_profiles
     WHERE profile_code = ? AND profile_version = ? FOR UPDATE`, [expected.profile_code, expected.profile_version]);
    if (rows.length !== 1)
        integrityError("AuthorityProfile 注册结果不唯一");
...
function verifyStoredRow(table, row, secrets) {
    ...
    if (String(persistedMac || "") !== rowMac(table, normalizedBase, secrets.factIntegrityKey)) {
...
async function loadRawRecords(source, teamId) {
    return (await queryRows(source, `SELECT * FROM prospect_source_raw_records${teamId ? " WHERE team_id = ?" : ""} ORDER BY team_id, owner_id, id`, teamId ? [teamId] : [])).map(rawRecord);
}
function scopedSelectionWhere(teamId, alternatives) {
    if (!teamId)
        return { sql: "", values: [] };
    if (!alternatives) {
        return { sql: " WHERE team_id = ?", values: [teamId] };
    }
    ...
    const predicates = populated.map((item) => `${item.column} IN (${item.values.map(() => "?").join(",")})`);
    return {
...
async function loadRawRecordsByScopes(source, teamId, scopes) {
    if (!scopes.length)
        return [];
    ...
    return (await queryRows(source, `SELECT * FROM prospect_source_raw_records
     WHERE team_id = ? AND (${predicates.join(" OR ")})
     ORDER BY team_id, owner_id, id`, [teamId, ...values])).map(rawRecord);
}
async function loadRelations(source, secrets, teamId, selection) {
    const resolutionWhere = scopedSelectionWhere(teamId, selection
        ? [{
                column: "resolution_id",
                values: selection.resolutionIds
            }]
        : undefined);
    const conflictWhere = scopedSelectionWhere(teamId, selection
        ? [{
                column: "conflict_id",
                values: selection.conflictIds
            }]
        : undefined);
    const identifierRows = await queryRows(source, `SELECT * FROM organization_identity_resolution_identifiers${resolutionWhere.sql}
     ORDER BY team_id, owner_id, resolution_id, ordinal`, resolutionWhere.values);
    const bindingRows = await queryRows(source, `SELECT * FROM organization_identity_resolution_bindings${resolutionWhere.sql}
     ORDER BY team_id, owner_id, resolution_id, ordinal`, resolutionWhere.values);
    const organizationRows = await queryRows(source, `SELECT * FROM organization_identity_conflict_organizations${conflictWhere.sql}
     ORDER BY team_id, owner_id, conflict_id, ordinal`, conflictWhere.values);
    const keyRows = await queryRows(source, `SELECT * FROM organization_identity_conflict_keys${conflictWhere.sql}
     ORDER BY team_id, owner_id, conflict_id, ordinal`, conflictWhere.values);
    return {
        resolutionIdentifiers: identifierRows.map((row) => {
            const base = verifyStoredRow("organization_identity_resolution_identifiers", row, secrets);
            return {
                ...
                role: String(base.relation_role),
                ordinal: Number(base.ordinal)
            };
        }),
        resolutionBindings: bindingRows.map((row) => {
            const base = verifyStoredRow("organization_identity_resolution_bindings", row, secrets);
            return {
                resolutionId: String(base.resolution_id),
                teamId: String(base.team_id),
                ownerId: String(base.owner_id),
        ...
        conflictOrganizations: organizationRows.map((row) => {
            const base = verifyStoredRow("organization_identity_conflict_organizations", row, secrets);
            return {
        ...
        conflictKeys: keyRows.map((row) => {
            const base = verifyStoredRow("organization_identity_conflict_keys", row, secrets);
            ...
            const keyType = String(base.key_type);
            const identifierKey = decryptField(String(base.identifier_key_encrypted), secrets.fieldEncryptionKey, fieldAad({
...
export async function loadOrganizationIdentityState(source, rawRecords, teamId, selection) {
    const secrets = configuredSecrets(false);
    const initialized = await validateMetadata(source, secrets);
    if (!initialized)
        return structuredClone(EMPTY_STATE);
    if (!secrets)
        configurationError("身份持久化密钥未初始化");
    if (selection && !teamId) {
        integrityError("企业身份决策闭包必须限定团队作用域");
    }
    const organizationWhere = scopedSelectionWhere(teamId, selection
        ? [{ column: "id", values: selection.organizationIds }]
        : undefined);
    const claimWhere = scopedSelectionWhere(teamId, selection
        ? [
            { column: "id", values: selection.claimIds },
            { column: "resolution_id", values: selection.resolutionIds }
        ]
        : undefined);
    const identifierWhere = scopedSelectionWhere(teamId, selection
        ? [{ column: "id", values: selection.identifierIds }]
        : undefined);
    const resolutionWhere = scopedSelectionWhere(teamId, selection
        ? [{ column: "id", values: selection.resolutionIds }]
        : undefined);
    const bindingWhere = scopedSelectionWhere(teamId, selection
        ? [{ column: "id", values: selection.bindingIds }]
        : undefined);
    const conflictWhere = scopedSelectionWhere(teamId, selection
        ? [{ column: "id", values: selection.conflictIds }]
        : undefined);
    const eventWhere = scopedSelectionWhere(teamId, selection
        ? [{ column: "resolution_id", values: selection.resolutionIds }]
        : undefined);
    const [organizationRows, claimRows, identifierRows, resolutionRows, bindingRows, conflictRows, eventRows, relations, profileRows] = await Promise.all([
        queryRows(source, `SELECT * FROM organizations${organizationWhere.sql}
       ORDER BY team_id, created_at, id`, organizationWhere.values),
        queryRows(source, `SELECT * FROM organization_identity_claims${claimWhere.sql}
       ORDER BY team_id, owner_id, resolution_id, ordinal`, claimWhere.values),
        queryRows(source, `SELECT * FROM organization_accepted_identifiers${identifierWhere.sql}
       ORDER BY team_id, created_at, id`, identifierWhere.values),
        queryRows(source, `SELECT * FROM organization_identity_resolutions${resolutionWhere.sql}
       ORDER BY team_id, owner_id, created_at, id`, resolutionWhere.values),
        queryRows(source, `SELECT * FROM organization_source_bindings${bindingWhere.sql}
       ORDER BY team_id, owner_id, created_at, id`, bindingWhere.values),
        queryRows(source, `SELECT * FROM organization_identity_conflicts${conflictWhere.sql}
       ORDER BY team_id, owner_id, created_at, id`, conflictWhere.values),
        queryRows(source, `SELECT * FROM organization_identity_events${eventWhere.sql}
       ORDER BY team_id, owner_id, resolution_id, sequence_no`, eventWhere.values),
        loadRelations(source, secrets, teamId, selection),
        queryRows(source, "SELECT * FROM organization_identity_authority_profiles")
    ]);
    ...
    const organizations = organizationRows.map((row) => {
        ...
        return {
            id,
            teamId: team,
            scopeType: String(base.scope_type),
            scopeId: String(base.scope_id),
            status: String(base.status),
            legalName: decryptField(String(base.legal_name_encrypted), secrets.fieldEncryptionKey, fieldAad({
                table: "organizations",
                teamId: team,
                rowId: id,
                field: "legal_name"
            })),
            normalizedName: decryptField(String(base.normalized_name_encrypted), secrets.fieldEncryptionKey, fieldAad({
                table: "organizations",
                teamId: team,
                rowId: id,
    ...
    const claims = claimRows.map((row) => {
        const base = verifyStoredRow("organization_identity_claims", row, secrets);
        const team = String(base.team_id);
        const owner = String(base.owner_id);
        const id = String(base.id);
        const resolutionId = String(base.resolution_id);
        const ordinal = Number(base.ordinal);
        const aad = (field) => fieldAad({
        ...
        return {
            ...
            originalValue: decryptField(String(base.original_value_encrypted), secrets.fieldEncryptionKey, aad("original_value")),
            normalizedValue: decryptField(String(base.normalized_value_encrypted), secrets.fieldEncryptionKey, aad("normalized_value")),
            scheme: String(base.scheme),
            jurisdiction: String(base.jurisdiction),
            entityType: String(base.entity_type),
            subjectRef: decryptField(String(base.subject_ref_encrypted), secrets.fieldEncryptionKey, aad("subject_ref")),
    ...
    const identifiers = identifierRows.map((row) => {
        const base = verifyStoredRow("organization_accepted_identifiers", row, secrets);
        const team = String(base.team_id);
        const id = String(base.id);
        ...
        return {
            ...
            scheme: String(base.scheme),
            jurisdiction: String(base.jurisdiction),
            normalizedValue: decryptField(String(base.normalized_value_encrypted), secrets.fieldEncryptionKey, fieldAad({
                table: "organization_accepted_identifiers",
                teamId: team,
                ownerId: owner,
                rowId: id,
    ...
    const bindings = bindingRows.map((row) => {
        const base = verifyStoredRow("organization_source_bindings", row, secrets);
        return {
            id: String(base.id),
            organizationId: String(base.organization_id),
            resolutionId: String(base.resolution_id),
    ...
    const conflicts = conflictRows.map((row) => {
        const base = verifyStoredRow("organization_identity_conflicts", row, secrets);
        const team = String(base.team_id);
        const owner = String(base.owner_id);
        const id = String(base.id);
        const organizationRelations = relations.conflictOrganizations.filter((item) => item.conflictId === id
            && item.teamId === team
            && item.ownerId === owner);
        const keyRelations = relations.conflictKeys.filter((item) => item.conflictId === id
            && item.teamId === team
            && item.ownerId === owner);
        return {
            id,
            ...
            ownerId: owner,
            rawRecordId: String(base.raw_record_id),
            conflictType: String(base.conflict_type),
            organizationIds: [...new Set(organizationRelations.map((item) => item.organizationId))].sort(),
    ...
    const resolutions = resolutionRows.map((row) => {
        const base = verifyStoredRow("organization_identity_resolutions", row, secrets);
        const team = String(base.team_id);
        const owner = String(base.owner_id);
        const id = String(base.id);
        const identifierRelations = relations.resolutionIdentifiers.filter((item) => item.resolutionId === id
            && item.teamId === team
            && item.ownerId === owner);
        const bindingRelations = relations.resolutionBindings.filter((item) => item.resolutionId === id
            && item.teamId === team
            && item.ownerId === owner);
        const conflict = conflicts.find((item) => item.resolutionId === id
            && item.teamId === team
            && item.ownerId === owner);
        return {
            id,
            ...
            claimHash: String(base.claim_hash),
            resolverContractVersion: String(base.resolver_contract_version),
            ...
            matchedIdentifierIds: identifierRelations
                .filter((item) => item.role === "matched_existing"
                || item.role === "accepted_existing")
                .map((item) => item.identifierId)
                .sort(),
            acceptedIdentifierIds: identifierRelations
                .filter((item) => item.role === "accepted_existing" || item.role === "accepted_new")
                .map((item) => item.identifierId)
                .sort(),
    ...
    const events = eventRows.map((row) => {
        const base = verifyStoredRow("organization_identity_events", row, secrets);
        return {
            id: String(base.id),
            resolutionId: String(base.resolution_id),
            teamId: String(base.team_id),
            ...
            eventType: String(base.event_type),
            organizationId: String(base.organization_id),
    ...
    for (const resolution of resolutions) {
        const profile = profiles.get(`${resolution.authorityProfileCode}\u0000`
        ...
        const expectedRelations = organizationIdentityResolutionRelations(resolution);
        ...
        if (canonical(expectedRelations) !== canonical({
            ...
            || resolution.relationHash
                !== organizationIdentityResolutionRelationHash(resolution, secrets.factIntegritySecret)) {
    ...
    for (const conflict of conflicts) {
        const actual = {
            organizations: relations.conflictOrganizations
                .filter((item) => item.conflictId === conflict.id
        ...
        if (conflict.relationHash
            !== organizationIdentityConflictRelationHash(actual, secrets.factIntegritySecret)) {
...
function memorySnapshot(store, rawRecords, state) {
    return {
        ...store,
        mode: "memory",
        prospectSourceRawRecords: structuredClone(rawRecords),
        organizations: structuredClone(state.organizations),
        organizationIdentityClaims: structuredClone(state.organizationIdentityClaims),
        organizationAcceptedIdentifiers: structuredClone(state.organizationAcceptedIdentifiers),
        organizationIdentityResolutions: structuredClone(state.organizationIdentityResolutions),
        organizationSourceBindings: structuredClone(state.organizationSourceBindings),
        organizationIdentityConflicts: structuredClone(state.organizationIdentityConflicts),
        organizationIdentityEvents: structuredClone(state.organizationIdentityEvents),
        async persist() {
...
function persistedResolverInput(input, profile, secrets) {
    return {
        ...input,
...
function prepareIdentityDecision(store, rawRecordValue, input, profile, secrets) {
    const local = memorySnapshot(store, [rawRecordValue], EMPTY_STATE);
    return resolveOrganizationStrongIdentity(local, persistedResolverInput(input, profile, secrets));
}
...
function addRawScope(target, ownerId, recordId) {
...
async function rowsByIds(source, table, teamId, ids, columns) {
    if (!ids.size)
        return [];
    return queryRows(source, `SELECT ${columns} FROM \`${table}\`
     WHERE team_id = ? AND id IN (${[...ids].map(() => "?").join(",")})`, [teamId, ...ids]);
}
async function relationRowsByParentIds(source, table, teamId, parentColumn, parentIds, columns) {
    if (!parentIds.size)
        return [];
    return queryRows(source, `SELECT ${columns} FROM \`${table}\`
     WHERE team_id = ? AND ${parentColumn} IN (${[...parentIds].map(() => "?").join(",")})`, [teamId, ...parentIds]);
}
async function discoverIdentityDecisionClosure(source, store, currentRaw, input, profile, secrets) {
    const prepared = prepareIdentityDecision(store, currentRaw, input, profile, secrets);
    ...
    const processingRows = await queryRows(source, `SELECT id FROM organization_identity_resolutions
    ...
    const initialBindingRows = await queryRows(source, `SELECT id,organization_id,resolution_id,owner_id,raw_record_id
    ...
    const identifierPredicates = [];
    const identifierValues = [input.teamId];
    if (identifierIds.size) {
        identifierPredicates.push(`id IN (${[...identifierIds].map(() => "?").join(",")})`);
        identifierValues.push(...identifierIds);
    }
    if (incomingIdentifiers.length) {
        identifierPredicates.push(`(status = 'active' AND (${incomingIdentifiers.map(() => "(kind = ? AND scheme = ? AND jurisdiction = ? "
            + "AND normalized_value_hash = ?)").join(" OR ")}))`);
        for (const identifier of incomingIdentifiers) {
            identifierValues.push(identifier.kind, identifier.scheme, identifier.jurisdiction, identifier.normalizedValueHash);
        }
    }
    if (identifierPredicates.length) {
        const initialIdentifierRows = await queryRows(source, `SELECT id,organization_id,source_claim_id,source_owner_id,
              source_raw_record_id
       FROM organization_accepted_identifiers
       WHERE team_id = ? AND (${identifierPredicates.join(" OR ")})`, identifierValues);
        for (const row of initialIdentifierRows) {
            addText(identifierIds, row.id);
            addText(organizationIds, row.organization_id);
            addText(targetOrganizationIds, row.organization_id);
            addText(claimIds, row.source_claim_id);
            addRawScope(rawScopes, row.source_owner_id, row.source_raw_record_id);
        }
    }
    if (targetOrganizationIds.size && incomingIdentifiers.length) {
        const slotPredicates = incomingIdentifiers.map(() => "(kind = ? AND scheme = ? AND jurisdiction = ?)");
        const sameSlotRows = await queryRows(source, `SELECT id FROM organization_accepted_identifiers
       WHERE team_id = ? AND status = 'active'
         AND organization_id IN (${[...targetOrganizationIds].map(() => "?").join(",")})
    ...
    for (let pass = 0; pass < 128; pass += 1) {
        ...
        const [resolutions, claims, identifiers, bindings, conflicts, resolutionIdentifierRelations, resolutionBindingRelations, conflictOrganizationRelations] = await Promise.all([
            rowsByIds(source, "organization_identity_resolutions", input.teamId, resolutionIds, "id,owner_id,raw_record_id,organization_id,binding_id,conflict_id"),
            queryRows(source, `SELECT id,resolution_id,owner_id,raw_record_id
         FROM organization_identity_claims
         WHERE team_id = ? AND (${resolutionIds.size
                ? `resolution_id IN (${[...resolutionIds].map(() => "?").join(",")})`
                : "1 = 0"}${claimIds.size
                ? ` OR id IN (${[...claimIds].map(() => "?").join(",")})`
                : ""})`, [input.teamId, ...resolutionIds, ...claimIds]),
            rowsByIds(source, "organization_accepted_identifiers", input.teamId, identifierIds, "id,organization_id,source_claim_id,source_owner_id,"
                + "source_raw_record_id"),
            rowsByIds(source, "organization_source_bindings", input.teamId, bindingIds, "id,organization_id,resolution_id,owner_id,raw_record_id"),
            rowsByIds(source, "organization_identity_conflicts", input.teamId, conflictIds, "id,resolution_id,owner_id,raw_record_id"),
            relationRowsByParentIds(source, "organization_identity_resolution_identifiers", input.teamId, "resolution_id", resolutionIds, "identifier_id"),
            relationRowsByParentIds(source, "organization_identity_resolution_bindings", input.teamId, "resolution_id", resolutionIds, "binding_id"),
            relationRowsByParentIds(source, "organization_identity_conflict_organizations", input.teamId, "conflict_id", conflictIds, "organization_id")
        ]);
    ...
    const rawRecords = await loadRawRecordsByScopes(source, input.teamId, [...rawScopes.values()]);
    const state = await loadOrganizationIdentityState(source, rawRecords, input.teamId, selection);
    return { rawRecords, state };
}
function storageOrganization(item, secrets) {
    const base = {
        id: item.id,
        team_id: item.teamId,
        ...
        status: item.status,
        legal_name_encrypted: encryptField(item.legalName, secrets.fieldEncryptionKey, fieldAad({
            table: "organizations",
            teamId: item.teamId,
            rowId: item.id,
            field: "legal_name"
        })),
        normalized_name_encrypted: encryptField(item.normalizedName, secrets.fieldEncryptionKey, fieldAad({
            table: "organizations",
            teamId: item.teamId,
            rowId: item.id,
            field: "normalized_name"
...
function storageClaim(item, secrets) {
    const aad = (field) => fieldAad({
        table: "organization_identity_claims",
        teamId: item.teamId,
    ...
    const base = {
        ...
        ordinal: item.ordinal,
        kind: item.kind,
        original_value_encrypted: encryptField(item.originalValue, secrets.fieldEncryptionKey, aad("original_value")),
        normalized_value_encrypted: encryptField(item.normalizedValue, secrets.fieldEncryptionKey, aad("normalized_value")),
        scheme: item.scheme,
        jurisdiction: item.jurisdiction,
        entity_type: item.entityType,
        subject_ref_encrypted: encryptField(item.subjectRef, secrets.fieldEncryptionKey, aad("subject_ref")),
    ...
    return {
        ...base,
        row_mac: rowMac("organization_identity_claims", base, secrets.factIntegrityKey)
    };
}
function storageIdentifier(item, secrets) {
    const base = {
        id: item.id,
        ...
        scheme: item.scheme,
        jurisdiction: item.jurisdiction,
        normalized_value_encrypted: encryptField(item.normalizedValue, secrets.fieldEncryptionKey, fieldAad({
            table: "organization_accepted_identifiers",
            teamId: item.teamId,
    ...
    return {
        ...base,
        row_mac: rowMac("organization_accepted_identifiers", base, secrets.factIntegrityKey)
    };
}
function storageResolution(item, secrets) {
    const base = {
        id: item.id,
        team_id: item.teamId,
        owner_id: item.ownerId,
    ...
    return {
        ...base,
        row_mac: rowMac("organization_identity_resolutions", base, secrets.factIntegrityKey)
    };
}
function storageBinding(item, secrets) {
    const base = {
        id: item.id,
        organization_id: item.organizationId,
        resolution_id: item.resolutionId,
    ...
    return {
        ...base,
        row_mac: rowMac("organization_source_bindings", base, secrets.factIntegrityKey)
    };
}
function storageConflict(item, secrets) {
    const base = {
        id: item.id,
        resolution_id: item.resolutionId,
        team_id: item.teamId,
    ...
    return {
        ...base,
        row_mac: rowMac("organization_identity_conflicts", base, secrets.factIntegrityKey)
    };
}
function storageEvent(item, secrets) {
    const base = {
        id: item.id,
        resolution_id: item.resolutionId,
        team_id: item.teamId,
    ...
    return {
        ...base,
        row_mac: rowMac("organization_identity_events", base, secrets.factIntegrityKey)
    };
}
async function insertRow(connection, table, row) {
    const columns = Object.keys(row);
    try {
        await connection.query(`INSERT INTO \`${table}\` (${columns.map((column) => `\`${column}\``).join(",")}) VALUES (${columns.map(() => "?").join(",")})`, columns.map((column) => column.endsWith("_at") ? new Date(String(row[column])) : row[column]));
    }
    catch (error) {
...
async function insertResolutionRelations(connection, resolution, secrets) {
    ...
    for (const item of relations.identifiers) {
        ...
        await insertRow(connection, "organization_identity_resolution_identifiers", {
            ...base,
            row_mac: rowMac("organization_identity_resolution_identifiers", base, secrets.factIntegrityKey)
        });
    }
    for (const item of relations.bindings) {
        ...
        await insertRow(connection, "organization_identity_resolution_bindings", {
            ...base,
            row_mac: rowMac("organization_identity_resolution_bindings", base, secrets.factIntegrityKey)
        });
    }
}
async function insertConflictRelations(connection, conflict, matchedOrganizationIds, existingBindingOrganizationId, secrets) {
    const relations = organizationIdentityConflictRelations(conflict, matchedOrganizationIds, existingBindingOrganizationId);
    if (conflict.relationHash
        !== organizationIdentityConflictRelationHash(relations, secrets.factIntegritySecret)) {
    ...
    for (const item of relations.organizations) {
        ...
        await insertRow(connection, "organization_identity_conflict_organizations", {
            ...base,
            row_mac: rowMac("organization_identity_conflict_organizations", base, secrets.factIntegrityKey)
        });
    }
    for (const item of relations.keys) {
        const encrypted = encryptField(item.identifierKey, secrets.fieldEncryptionKey, fieldAad({
            table: "organization_identity_conflict_keys",
        ...
        await insertRow(connection, "organization_identity_conflict_keys", {
            ...base,
            row_mac: rowMac("organization_identity_conflict_keys", base, secrets.factIntegrityKey)
        });
    }
}
async function appendResult(connection, result, before, secrets) {
    if (result.idempotent)
        return;
    if (result.createdOrganization) {
        await insertRow(connection, "organizations", storageOrganization(result.createdOrganization, secrets));
    }
    await insertRow(connection, "organization_identity_resolutions", storageResolution(result.resolution, secrets));
    for (const claim of result.claims) {
        await insertRow(connection, "organization_identity_claims", storageClaim(claim, secrets));
    }
    for (const identifier of result.createdIdentifiers) {
        await insertRow(connection, "organization_accepted_identifiers", storageIdentifier(identifier, secrets));
    }
    const bindingIsNew = result.binding
        && !before.organizationSourceBindings.some((item) => item.id === result.binding.id);
    if (bindingIsNew && result.binding) {
        await insertRow(connection, "organization_source_bindings", storageBinding(result.binding, secrets));
    }
    if (result.conflict) {
        await insertRow(connection, "organization_identity_conflicts", storageConflict(result.conflict, secrets));
    }
    await insertResolutionRelations(connection, result.resolution, secrets);
    if (result.conflict) {
        const identifiersById = new Map(before.organizationAcceptedIdentifiers.map((item) => [item.id, item]));
        const matchedOrganizationIds = result.resolution.matchedIdentifierIds
            .map((id) => identifiersById.get(id)?.organizationId || "")
            .filter(Boolean);
        const existingBinding = before.organizationSourceBindings.find((item) => item.teamId === result.resolution.teamId
            && item.ownerId === result.resolution.ownerId
            && item.rawRecordId === result.resolution.rawRecordId
            && item.status === "active");
        await insertConflictRelations(connection, result.conflict, matchedOrganizationIds, existingBinding?.organizationId || "", secrets);
    }
    for (const event of result.events) {
        await insertRow(connection, "organization_identity_events", storageEvent(event, secrets));
    }
}
function replaceIdentityState(store, state) {
...
function replaceTeamIdentityState(store, teamId, state, guardVersion) {
    const versions = identityCacheVersions.get(store) || new Map();
    const currentVersion = versions.get(teamId) || 0;
    if (guardVersion !== undefined && guardVersion < currentVersion)
        return false;
    const names = Object.keys(state);
    for (const name of names) {
        const target = store[name];
        target.splice(0, target.length, ...target.filter((item) => item.teamId !== teamId), ...structuredClone(state[name]));
    }
...
function currentTeamCacheVersion(store, teamId) {
    return identityCacheVersions.get(store)?.get(teamId) || 0;
}
function invalidateTeamCache(store, teamId, maximumVersion) {
    const versions = identityCacheVersions.get(store) || new Map();
    const currentVersion = versions.get(teamId) || 0;
    if (maximumVersion !== undefined && currentVersion > maximumVersion) {
        return false;
    }
    const highWaterVersion = Math.max(currentVersion, maximumVersion || 0);
...
async function recoverCommittedResult(pool, store, input, profile, secrets) {
    let connection = null;
    let destroyed = false;
    ...
    try {
        ...
        await connection.query(`INSERT INTO organization_identity_team_guards (
         team_id,guard_version,updated_at
       ) VALUES (?,1,?)
       ON DUPLICATE KEY UPDATE team_id = VALUES(team_id)`, [input.teamId, new Date(input.resolvedAt)]);
        const guardRows = await queryRows(connection, `SELECT team_id FROM organization_identity_team_guards
       WHERE team_id = ? FOR UPDATE`, [input.teamId]);
        if (guardRows.length !== 1) {
            integrityError("未知 COMMIT 恢复无法建立团队事务保护记录");
        }
        const rawRows = await queryRows(connection, `SELECT * FROM prospect_source_raw_records
       WHERE team_id = ? AND owner_id = ? AND id = ?`, [input.teamId, input.ownerId, input.rawRecordId]);
        if (rawRows.length !== 1) {
            integrityError("未知 COMMIT 恢复无法确认 Provider 原始记录");
        }
        const closure = await discoverIdentityDecisionClosure(connection, store, rawRecord(rawRows[0]), input, profile, secrets);
        const local = memorySnapshot(store, closure.rawRecords, closure.state);
        ...
        throw new OrganizationStrongIdentityError("IDENTITY_COMMIT_OUTCOME_UNKNOWN", "企业身份事务 COMMIT 结果仍无法确认");
    }
    finally {
...
async function refreshTeamCacheGuarded(pool, store, teamId) {
    let connection = null;
    let transactionStarted = false;
    let commitStarted = false;
    let destroyed = false;
    ...
    try {
        ...
        await connection.beginTransaction();
        transactionStarted = true;
        const guards = await queryRows(connection, `SELECT team_id,guard_version FROM organization_identity_team_guards
       WHERE team_id = ? FOR UPDATE`, [teamId]);
        if (guards.length !== 1) {
        ...
        const state = await loadOrganizationIdentityState(connection, rawRecords, teamId);
        commitStarted = true;
        await connection.commit();
        transactionStarted = false;
        return replaceTeamIdentityState(store, teamId, state, observedVersion)
            ? "fresh"
            : "stale";
    }
    catch {
...
export async function ensureOrganizationIdentityTeamCache(pool, store, teamId) {
    for (let attempt = 1; attempt <= 2; attempt += 1) {
        const status = await refreshTeamCacheGuarded(pool, store, teamId);
        if (status !== "unavailable")
            return status;
    }
    throw new OrganizationStrongIdentityError("IDENTITY_CACHE_UNAVAILABLE", "企业身份已保存，但当前实例暂时无法刷新团队数据，请重试");
}
function assertNamedDuplicateRecoveryResult(rule, result) {
...
async function resolveNamedDuplicateInNewTransaction(pool, store, input, profile, secrets, rule, commitAttempt = 1) {
    const connection = await pool.getConnection();
    let destroyed = false;
    let commitStarted = false;
    ...
    try {
       ...
       ON DUPLICATE KEY UPDATE team_id = VALUES(team_id)`, [input.teamId, new Date(input.resolvedAt)]);
        await connection.query(`SELECT team_id FROM organization_identity_team_guards
       WHERE team_id = ? FOR UPDATE`, [input.teamId]);
        const lockedRaw = await queryRows(connection, `SELECT * FROM prospect_source_raw_records
       WHERE team_id = ? AND owner_id = ? AND id = ? FOR UPDATE`, [input.teamId, input.ownerId, input.rawRecordId]);
        if (lockedRaw.length !== 1) {
            throw new OrganizationStrongIdentityError("IDENTITY_INVALID", "Provider 原始记录不存在或不属于当前业务员");
        }
        const closure = await discoverIdentityDecisionClosure(connection, store, rawRecord(lockedRaw[0]), input, profile, secrets);
        const local = memorySnapshot(store, closure.rawRecords, closure.state);
        const result = resolveOrganizationStrongIdentity(local, persistedResolverInput(input, profile, secrets));
        assertNamedDuplicateRecoveryResult(rule, result);
        await appendResult(connection, result, closure.state, secrets);
        await connection.query(`UPDATE organization_identity_team_guards
       SET guard_version = guard_version + 1, updated_at = ?
       WHERE team_id = ?`, [new Date(input.resolvedAt), input.teamId]);
        commitStarted = true;
        await connection.commit();
        ...
        if (commitStarted) {
            ...
            const recovered = await recoverCommittedResult(pool, store, input, profile, secrets);
            if (recovered.status === "committed") {
                await ensureOrganizationIdentityTeamCache(pool, store, input.teamId);
                return recovered.result;
            }
            if (commitAttempt < 3) {
                return resolveNamedDuplicateInNewTransaction(pool, store, input, profile, secrets, rule, commitAttempt + 1);
            }
            throw new OrganizationStrongIdentityError("IDENTITY_CONCURRENCY_RETRY_EXHAUSTED", "企业身份命名重复键恢复事务已确认未提交，重跑次数已耗尽");
        }
...
export async function resolveOrganizationStrongIdentityMysql(pool, store, input) {
    const secrets = configuredSecrets(true);
    const frozenInput = frozenPersistedInput(input);
    const profile = frozenAuthorityProfile(trustedProfile(frozenInput.authorityProfileCode, frozenInput.authorityProfileVersion));
    let lastRetryable;
    for (let attempt = 1; attempt <= 3; attempt += 1) {
        ...
        try {
            ...
            await registerProfile(connection, profile, frozenInput.resolvedAt, secrets);
            await connection.query(`INSERT INTO organization_identity_team_guards (
           team_id,guard_version,updated_at
         ) VALUES (?,1,?)
         ON DUPLICATE KEY UPDATE team_id = VALUES(team_id)`, [frozenInput.teamId, new Date(frozenInput.resolvedAt)]);
            await connection.query(`SELECT team_id FROM organization_identity_team_guards
         WHERE team_id = ? FOR UPDATE`, [frozenInput.teamId]);
            const lockedRaw = await queryRows(connection, `SELECT * FROM prospect_source_raw_records
         WHERE team_id = ? AND owner_id = ? AND id = ? FOR UPDATE`, [
            ...
            const closure = await discoverIdentityDecisionClosure(connection, store, rawRecord(lockedRaw[0]), frozenInput, profile, secrets);
            const local = memorySnapshot(store, closure.rawRecords, closure.state);
            const result = resolveOrganizationStrongIdentity(local, persistedResolverInput(frozenInput, profile, secrets));
            await appendResult(connection, result, closure.state, secrets);
            await connection.query(`UPDATE organization_identity_team_guards
         SET guard_version = guard_version + 1, updated_at = ?
         WHERE team_id = ?`, [new Date(frozenInput.resolvedAt), frozenInput.teamId]);
            commitStarted = true;
            await connection.commit();
            commitCompleted = true;
            await ensureOrganizationIdentityTeamCache(pool, store, frozenInput.teamId);
            return result;
        }
        catch (error) {
            if (commitCompleted)
            ...
            if (commitStarted) {
                ...
                const recovered = await recoverCommittedResult(pool, store, frozenInput, profile, secrets);
                if (recovered.status === "committed") {
                    await ensureOrganizationIdentityTeamCache(pool, store, frozenInput.teamId);
                    return recovered.result;
                }
                ...
                throw new OrganizationStrongIdentityError("IDENTITY_COMMIT_OUTCOME_UNKNOWN", "企业身份事务 COMMIT 结果无法在重跑后确认");
            }
            let rollbackSucceeded = false;
            try {
                await connection.rollback();
            ...
            if (isRetryable(error)) {
                ...
                if (attempt < 3)
                    continue;
                throw new OrganizationStrongIdentityError("IDENTITY_CONCURRENCY_RETRY_EXHAUSTED", "企业身份事务并发重试次数已耗尽");
            }
            if (isDuplicateEntry(error)) {
                ...
                connection.release();
                connectionClosed = true;
                return await resolveNamedDuplicateInNewTransaction(pool, store, frozenInput, profile, secrets, rule);
            }
            throw error;
        }
        finally {
