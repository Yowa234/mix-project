...
import { PROSPECT_COVERAGE_MEMORY_CONTRACT, listOwnerProspectCoverageEvents, listTenantProspects, recordProspectCoverage, setTenantProspectDisposition } from "./prospect-coverage-memory.js";
...
function addOrganization(teamId, organizationId) {
    const organization = {
        id: organizationId,
        teamId,
        scopeType: "team",
...
function assertBusinessDataUnchanged(before) {
